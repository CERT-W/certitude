...
#
# $Id: srvsvc.py 892 2013-11-02 20:59:37Z bethus $
#
...
class SESSION_INFO_502(Structure):
    class nonDeferred(Structure):
        structure = (
            ('sesi502_cname',':',ndrutils.NDRPointer),
            ('sesi502_username',':',ndrutils.NDRPointer),
            ('sesi502_num_opens','<L=0'),
            ('sesi502_time','<L=0'),
            ('sesi502_idle_time','<L=0'),
            ('sesi502_user_flags','<L=0'),
            ('sesi502_cltype_name',':', ndrutils.NDRPointer),
            ('sesi502_transport',':', ndrutils.NDRPointer),
        )
...
class SESSION_ENUM_STRUCT(Structure):
    structure = (
        ...
        ('pContainer',':', ndrutils.NDRPointer),
...
class SHARE_INFO_1(Structure):
    class nonDeferred(Structure):
        structure = (
            ('shi1_netname',':',ndrutils.NDRPointer),
            ('shi1_type','<L=0'),
            ('shi1_remark',':', ndrutils.NDRPointer),
        )
...
class SHARE_INFO_2(Structure):
    structure = (
        ('shi2_netname',':', ndrutils.NDRPointer),
        ('shi2_type','<L=0'),
        ('shi2_remark',':', ndrutils.NDRPointer),
        ('shi2_permissions','<L=0'),
        ('shi2_max_uses','<L=0'),
        ('shi2_current_uses','<L=0'),
        ('shi2_path',':', ndrutils.NDRPointer),
        ('shi2_passwd',':', ndrutils.NDRPointer),
        ('netname',':', ndrutils.NDRStringW),
        ('remark',':', ndrutils.NDRStringW),
...
class SRVSVCShareEnum(Structure):
    ...
    structure = (
       ...
       ('pResumeHandle', ':', ndrutils.NDRPointer),
       ('ResumeHandle', '<L=0'),
    )
...
class DCERPCSrvSvc:
    ...
    def NetrShareEnum(self, serverName='', preferedMaximumLength=0xffffffff, resumeHandle=0):
        ...
        shareEnum['InfoStruct']['pContainer'] =  ndrutils.NDRPointer()
        shareEnum['InfoStruct']['ShareInfo'] = SHARE_INFO_1_CONTAINER()
        shareEnum['InfoStruct']['ShareInfo']['pBuffer'] = ndrutils.NDRPointer()
        ...
        shareEnum['pResumeHandle'] = ndrutils.NDRPointer()
    ...
    def NetrSessionEnum(self, serverName='', clientName='', userName='', preferedMaximumLength=0xffffffff, resumeHandle=0): 
        ...
        sessionEnum['InfoStruct']['pContainer'] =  ndrutils.NDRPointer()
        sessionEnum['InfoStruct']['SessionInfo'] = SESSION_INFO_502_CONTAINER()
        sessionEnum['InfoStruct']['SessionInfo']['pBuffer'] = ndrutils.NDRPointer()
        ...
        sessionEnum['pResumeHandle'] = ndrutils.NDRPointer()
